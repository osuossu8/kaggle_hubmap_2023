...
data_root = f'/workspace/kaggle_hubmap_2023/input/hubmap-converted-to-coco-ds1-ds2-5fold/fold{fold}/'
additional_data_root = f'/workspace/kaggle_hubmap_2023/input/ds1_ds2_th_0_9/fold{fold}/'
...
train_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        # data_root=additional_data_root,
        metainfo=metainfo,
