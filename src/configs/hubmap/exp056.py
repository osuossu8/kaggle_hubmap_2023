...
BATCH_SIZE = 2 # 4
NUM_CLASSES = 3
IMG_SIZE_HW = (896, 896) # (768, 768) # (640, 640)
...
_base_ = '/workspace/kaggle_hubmap_2023/src/mmdetection/configs/mask2former/mask2former_swin-s-p4-w7-224_8xb2-lsj-50e_coco.py'
