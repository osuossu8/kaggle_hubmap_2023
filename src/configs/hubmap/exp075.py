...
DATASET_NAME = 'hubmap-coco-ds3-5fold-pl-0-9-dilate-by-exp062' # 'hubmap-converted-to-coco-5fold-v2-3class'
fold = None
EXP_ID = '075'
SEED = 42
EPOCHS = 20
...
# checkpoint_file = glob.glob(f'/workspace/kaggle_hubmap_2023/src/work_dirs/exp074/fold{fold}/best_coco_segm_mAP_epoch_*.pth')[-1]