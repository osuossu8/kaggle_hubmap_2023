...
def main():
    ...
    for fold in [0, 1, 2, 3, 4]:
        ...
        # TRAIN_DATASET_NAME = 'merge_with_ds3_v1_th09_by068'
        ...
        fold_manage_dict = dict(
            ...
            test_evaluator=dict(ann_file=data_root + "val/annotation_coco.json"),
        )
        # merge fold_manage_dict to mmdetection config
        cfg.merge_from_dict(fold_manage_dict)
