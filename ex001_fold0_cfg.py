...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/kqi/output/Work/team_data_train_mmdet226/kaeru_078_hubmap-converted-to-coco-5fold-v2-3class/hubmap-converted-to-coco-5fold-v2-3class/fold0/train/annotation_coco.json',
        img_prefix=
        '/kqi/output/Work/team_data_train_mmdet226/kaeru_078_hubmap-converted-to-coco-5fold-v2-3class/hubmap-converted-to-coco-5fold-v2-3class/fold0/train/',
        pipeline=[
            dict(type='LoadImageFromFile', to_float32=True),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/kqi/output/Work/team_data_train_mmdet226/kaeru_078_hubmap-converted-to-coco-5fold-v2-3class/hubmap-converted-to-coco-5fold-v2-3class/fold0/val/annotation_coco.json',
        img_prefix=
        '/kqi/output/Work/team_data_train_mmdet226/kaeru_078_hubmap-converted-to-coco-5fold-v2-3class/hubmap-converted-to-coco-5fold-v2-3class/fold0/val/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
checkpoint_config = dict(
    interval=1, by_epoch=True, save_last=True, max_keep_ckpts=3)
log_config = dict(
    interval=100,
    hooks=[
...
seed = 42
classes = ('blood_vessel', 'glomerulus', 'unsure')
work_dir = '/kqi/output/Work/team_data_train_mmdet226/kaeru_078_hubmap-converted-to-coco-5fold-v2-3class/outputs/ex001_fold0'
gpu_ids = [0]
auto_resume = False
